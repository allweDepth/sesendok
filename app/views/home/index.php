                ...
                <div class="ui grid stackable container">
                    <div class="column">
                        ...
                        <div class="ui three stackable cards">
                            ...
                            $data_card->informasi_umum = ['header' => 'Informasi Umum', 'meta' => 'Aplikasi Standar Satuan Harga (SSH)', 'description' => 'sebagai perhitungan kebutuhan biaya Tenaga Kerja, bahan, dan peralatan', 'icon' => 'purple sitemap'];
                            $data_card->rab = ['header' => 'Rencana Anggaran Biaya', 'meta' => 'Aplikasi Standar Satuan Harga (SSH)', 'description' => 'sebagai perhitungan kebutuhan biaya Tenaga Kerja, bahan, dan peralatan', 'icon' => 'teal money bill alternate outline'];
