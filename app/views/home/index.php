                ...
                <div class="ui grid stackable container">
                    <div class="column">
                        ...
                        <div class="ui three stackable cards">
                            ...
                            $data_card->mapping = ['header' => 'MAPPING', 'meta' => 'mapping neraca dan akun', 'description' => 'sebagai perhitungan kebutuhan biaya Tenaga Kerja, bahan, dan peralatan', 'icon' => 'violet users cog'];
                            if ($type_user == 'admin') {
