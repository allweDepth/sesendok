...
class User
{
    ...
    private $_formItem = [];
    public
    function validasiInsert($formMethod)
    {
    ...
    function login()
    {
        ...
        //$g=$this->generate( $_SESSION[ "username" ] );
        //var_dump($g);
        //var_dump($_SESSION);
    ...
    public
    function validasiUbahPassword($formMethod)
    {
        $validate = new Validate($formMethod);
