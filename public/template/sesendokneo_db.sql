...
--
-- Host: localhost
-- Waktu pembuatan: 01 Feb 2024 pada 21.22
...
CREATE TABLE `sub_kegiatan_neo` (
  ...
  `kode` varchar(25) NOT NULL,
  `kd_prov` varchar(25) NOT NULL,
  `kd_kab` varchar(25) NOT NULL,
...
(2, 'nabiila', 'nabiila@gmail.com', 'nabiila', '$2y$10$Zxp6h5J9v8MiUtUZpDvNKe81qhVaN9gBTVusn/ov9mVwti/du1q1G', '', 'PT. Angin Ribat Skali dan satgat mengesankan sekali', 'admin', 'images/avatar/bbf4f78067dad81bec03965da604932e9e18f570_2.jpg', '2018-06-09 15:54:29', '2024-02-02 03:50:11', '2024', '08128888', 80.00, 'non', 'short', 0, 0, 0, 0, 1, 'Apa yang dapat saya berikan untuk Pasangkayu'),
