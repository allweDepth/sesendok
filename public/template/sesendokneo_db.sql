...
--
-- Host: localhost
-- Waktu pembuatan: 22 Feb 2024 pada 10.53
...
CREATE TABLE `renja_neo` (
  ...
  `kd_sub_keg` varchar(22) NOT NULL,
  `kd_akun` varchar(22) NOT NULL,
  `kel_kd_sub_keg_kd_akun` varchar(50) NOT NULL DEFAULT '0',
