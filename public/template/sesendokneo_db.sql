...
--
-- Host: localhost
-- Waktu pembuatan: 16 Feb 2024 pada 07.03
...
CREATE TABLE `sub_keg_renja_neo` (
  ...
  `jumlah` decimal(12,0) NOT NULL,
  `jumlah_p` decimal(12,0) NOT NULL,
  `disable` tinyint(1) NOT NULL,
