...
--
-- Host: localhost
-- Waktu pembuatan: 13 Feb 2024 pada 15.27
...
CREATE TABLE `renstra_skpd_neo` (
  ...
  `target_thn_6` decimal(20,12) DEFAULT NULL,
  `dana_thn_6` decimal(20,12) DEFAULT NULL,
