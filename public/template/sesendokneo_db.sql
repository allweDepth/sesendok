...
--
-- Host: localhost
-- Waktu pembuatan: 23 Feb 2024 pada 15.41
...
CREATE TABLE `renja_neo` (
  ...
  `kd_sub_keg` varchar(22) NOT NULL,
  `kd_akun` varchar(22) NOT NULL,
  `kel_rekening` varchar(50) NOT NULL DEFAULT '0',
